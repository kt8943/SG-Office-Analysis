...
([data_summary.py](data_summary.py)). It focuses on **strata office sale transactions** and
...
PGIM_Office/
  ...
  app.py                    # Streamlit entry / router (st.navigation -> views/*.py)
  ...
  outputs/                  # generated by data_summary.py (summary_numeric.csv, summary_categorical.csv)
...
lives in `views/`), plus a standalone summary script.

### Overview ([views/overview.py](views/overview.py))
